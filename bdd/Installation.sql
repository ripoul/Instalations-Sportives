...
CREATE TABLE IF NOT EXISTS `installation` (
  ...
  `CP` int(11) CHARACTER SET utf8 NOT NULL,
  `equipement` int(11) CHARACTER SET utf8 NOT NULL
...
ALTER TABLE `installation`
ADD CONSTRAINT `installation_equ` FOREIGN KEY (`equipement`) REFERENCES `equipement` (`id`);